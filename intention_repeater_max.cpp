/*
    Intention Repeater MAX v2.1 created by Thomas Sweet.
    ...
    Repeats your intention up to 10+ million times per second to make things happen.
...
int main(int argc, char ** argv) {
    std::string intention, intention_value, process_intention, status, param_duration, param_intention, duration, runtime_formatted;
    ...
    cout << "Intention Repeater MAX v2.1 created by Thomas Sweet." << endl;
