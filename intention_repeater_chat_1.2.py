...
sys.stdout.write('Intention Repeater Spiritual Chat v1.2 software created by Thomas Sweet.\n')
...
try:
    while True:
        ...
        for c in range(1, num_words_response + 1):
            ...
            runtime = str(time.strftime('%H:%M:%S', time.gmtime(int(time.time() - start_time))))

        num_writes = 0
        sys.stdout.write('\n[100%] (' + runtime + ') Response: ' + response_value + '\n')
        response_value = ''
        query = ''
